  ...
  render() {
    return (
      <div className="-p-a-2 gds-flex gds-flex--align-center" style={{'height': '100%'}}>
        <div className="gds-flex gds-flex__item -text-center" style={{'maxWidth': '1200px', 'marginLeft': 'auto', 'marginRight': 'auto', 'flexDirection': 'column', 'alignItems': 'center', 'justifyContent': 'center'}}> 
          <i
              className=
