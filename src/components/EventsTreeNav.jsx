...
import eventsTree from "../constants/EventsTree";

class EventsTreeNav extends Component {
  constructor(props) {
    super(props); 
      this.state = {
        toggle: false, 
  ...
  render() { 
    ...
    return (
      ...
      <div className="gds-layout__column--lg-2 gds-layout__column--md-12">
        <div className="gds-card -pos-fix -overflow-x-scroll" style={{'height': '100%', 'width': '20rem', 'right': '0'}}> 
          <div className="gds-card__block -pos-fix">
            {eventsTree.map((item, index) => {
              return (
