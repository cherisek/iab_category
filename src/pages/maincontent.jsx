      ...
      <Fragment>
        <div className="gds-flex-grid__container">
          <div className="gds-flex-grid__item">
            <h5 className="gds-text-header-sm -m-b-2" style={{'float': 'left'}}>Automotive</h5> 
          ...
          <div className="gds-flex-grid__container">
            ...
            <div className="gds-flex-grid__row" style={{'paddingRight': '0px', 'marginBottom': '0px'}}>
              ...
              <div className="gds-flex-grid__item -m-b-3">
                <h5 className="gds-text-header-sm -m-b-2" style={{'float': 'left'}}>Books and Literature</h5> 
                <i className="arrow-right"></i>
              </div>
              <br />
              <div className="gds-flex-grid__item -m-b-3">
                <h5 className="gds-text-header-sm -m-b-2" style={{'float': 'left'}}>Business and Finance</h5> 
                <i className="arrow-right"></i>
              </div>
              <br/>
              ...
              <div className="gds-flex-grid__item">
            <h5 className="gds-text-header-sm -m-b-2" style={{'float': 'left'}}>Careers</h5> 
            <i className="arrow-down"></i>
          </div>
          <div className="gds-flex-grid__container">
              {/* change padding later and do real calculations for smooth grid layout*/}
            ...
            <div className="gds-flex-grid__row" style={{'paddingRight': '0px', 'marginBottom': '0px'}}>
              ...
              <br/>
              <div className="gds-flex-grid__item -m-b-3">
                <h5 className="gds-text-header-sm -m-b-2" style={{'float': 'left'}}>Education</h5> 
                <i className="arrow-right"></i>
              </div>
              <br />
              <div className="gds-flex-grid__item -m-b-3">
                <h5 className="gds-text-header-sm -m-b-2" style={{'float': 'left'}}>Events and Attractions</h5> 
                <i className="arrow-right"></i>
              </div>
